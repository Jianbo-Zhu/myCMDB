...
import net.jianbo.cmdb.config.Constants;
import net.jianbo.cmdb.domain.Authority;
import net.jianbo.cmdb.domain.User;
import net.jianbo.cmdb.repository.AuthorityRepository;
import net.jianbo.cmdb.repository.UserRepository;
import net.jianbo.cmdb.security.AuthoritiesConstants;
import net.jianbo.cmdb.service.MailService;
import net.jianbo.cmdb.service.UserService;
import net.jianbo.cmdb.service.dto.PasswordChangeDTO;
import net.jianbo.cmdb.service.dto.UserDTO;
import net.jianbo.cmdb.web.rest.errors.ExceptionTranslator;
import net.jianbo.cmdb.web.rest.vm.KeyAndPasswordVM;
import net.jianbo.cmdb.web.rest.vm.ManagedUserVM;
