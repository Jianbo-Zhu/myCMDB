...
import net.jianbo.cmdb.config.audit.AuditEventConverter;
import net.jianbo.cmdb.domain.PersistentAuditEvent;
...
import static net.jianbo.cmdb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
