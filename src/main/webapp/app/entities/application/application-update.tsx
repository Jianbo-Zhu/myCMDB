...
export class ApplicationUpdate extends React.Component<IApplicationUpdateProps, IApplicationUpdateState> {
  ...
  render() {
    const { applicationEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="myCmdbApp.application.home.createOrEditLabel">
              <Translate contentKey="myCmdbApp.application.home.createOrEditLabel">Create or edit a Application</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : applicationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="appNameLabel" for="appName">
                ...
                <AvGroup>
                  <Label id="environmentLabel" for="environment">
