    ...
    return (
      <div>
        <h2 id="application-heading">
          <Translate contentKey="myCmdbApp.application.home.title">Applications</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="myCmdbApp.application.home.createLabel">Create new Application</Translate>
          </Link>
        </h2>
