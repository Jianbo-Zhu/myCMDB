...
```
$ docker image tag mycmdb ops-tools/mycmdb
$ docker push ops-tools/mycmdb
```
...
```
$ kubectl get svc mycmdb -n ops-tools
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n ops-tools
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n ops-tools
```
